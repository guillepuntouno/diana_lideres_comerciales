...
class RutasServicio {
  ...
  Future<Map<String, dynamic>> obtenerClientesPorRutaConJson(String codigoLider, String codigoDiaVisita, String ruta) async {
    try {
      ...
      if (response.statusCode == 200) {
        ...
        final negocios = data.map((clienteData) {
          return Negocio(
